...
def clean_data_env(tmp_path: pathlib.Path, monkeypatch: pytest.MonkeyPatch) -> Generator[None]:
...
class TestCLIJobIngestion:
    ...
    @patch("job_genie.core.orchestrator.JobSearcher")
...
class TestCLIJobAnalysis:
    ...
    @patch("job_genie.core.orchestrator.JobDetailsExtractor")
    @patch("job_genie.core.orchestrator.get_llm_client")
    @patch("job_genie.core.orchestrator.PDFResumeParser")
    ...
    @patch("job_genie.core.orchestrator.JobDetailsExtractor")
    @patch("job_genie.core.orchestrator.EmailService")
