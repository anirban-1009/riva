...
from job_genie.core.llm_client import FallbackClient, GeminiClient, LLMClient, OllamaClient, get_llm_client


class TestLLMClient:
    """Test suite for LLMClient and its implementations."""

    @patch("job_genie.core.ai.gemini.genai.Client")
    ...
    def test_factory_gemini(self):
        ...
        with patch("job_genie.core.ai.gemini.genai.Client"):
