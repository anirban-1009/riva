...
from job_genie.core.network_graph import Connection
...
class TestReferralService:
    ...
    def referral_service(self, mock_llm):
        ...
        with patch("job_genie.core.referral_service.NetworkGraphBuilder"):
    ...
    def test_find_potential_connections(self, referral_service):
        ...
        with patch("job_genie.core.referral_service.NetworkGraphBuilder") as mock_builder_cls:
    ...
    def test_generate_message_exceeds_max_chars_warning(self, referral_service):
        ...
        with patch("job_genie.core.referral_service.logger") as mock_logger:
