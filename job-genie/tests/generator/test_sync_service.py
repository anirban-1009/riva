...
from job_genie.ingest.job_details_extractor import JobDetails
...
class TestSyncService:
    ...
    def sync_service(self, mock_config):
        with (
            patch("job_genie.generator.sync_service.VaultManager"),
            patch("job_genie.generator.sync_service.TemplateManager"),
            patch("job_genie.generator.sync_service.DashboardGenerator"),
            patch("job_genie.generator.sync_service.JobDetailsExtractor"),
        ):
    ...
    def test_sync_all(self, sync_service):
        ...
        with patch("job_genie.generator.sync_service.NetworkGraphBuilder") as mock_builder_class:
