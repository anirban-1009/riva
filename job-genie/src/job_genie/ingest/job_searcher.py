...
from job_genie.core.constants import LINKEDIN_JOBS_SEARCH_URL, ExperienceLevel, JobType, LocationType
from job_genie.ingest.browser_manager import BrowserManager
from job_genie.ingest.selectors import (
...
class JobSearcher:
    ...
    def _get_best_locator(self, root: Any, selectors: list[str]) -> Any | None:
